...
//		matchRepo.save(
//				new Match(null,"testName13",new Date(),"lieu","firstequipe","secondequipe")
//		);
//
//		Match m = matchRepo.findByRef("testName13");
//		System.out.println(m.getRef());
//
//		for(int i=1; i<2023; i++){
//			ticketrepo.save(new Ticket(null,"reff"+i ,i,(i%2 == 0) ? Statut.ACTIVER : Statut.DESACTIVER,m));
//
//		}
	}
}
